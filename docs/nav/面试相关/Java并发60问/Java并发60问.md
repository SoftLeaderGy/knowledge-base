...
![](images/c6cfe8d5-8c76-40f8-98e3-899e60f5a3cd.jpg)
线程常用调度方法
...
![](images/c8043456-624d-4458-96e4-2fd5a0a35def.jpg)
ThreadLocal内存分配
...
![](images/776f2f3c-dfbe-48a2-9ed4-996174f52a2d.jpg)
...
![](images/f8b5db7b-dc98-4d3a-9a31-0f34dfb7d4dc.jpg)
Java内存模型
...
![](images/f797099d-83c4-4923-9e65-13ac313a2215.jpg)
双重校验单例模式异常情形
...
![](images/a6652489-5cb6-4b53-a559-e159aa571b1a.jpg)
happens-before六大规则
...
volatile可以确保对某个变量的更新对其他线程马上可见，一个变量被声明为volatile
...
![](images/5ab61aaf-d321-4e4f-99bd-5a961748d7ea.jpg)
volatile写插入内存屏障后生成的指令序列示意图
...
如果⼀个线程 A 调⽤⼀个实例对象的⾮静态 synchronized ⽅法，⽽线程 B 需要调⽤这个实例对象所属类的静态 synchronized
...
![](images/d5076aa0-bacb-4bdb-8a33-c5a891a089ae.jpg)
CLH队列
...
![](images/e57e5b75-92e7-4ddb-b021-1acde6855fa6.jpg)
公平锁tryAcquire
...
![](images/a525e6a4-2443-4183-8e61-a21fce488c1f.jpg)
原子操作类
...
![](images/1571cfc6-6372-452d-8038-b33eafa641bf.jpg)
线程死锁检测
...
![](images/2be6996b-e11d-4bde-a840-bc285b786606.jpg)
王者荣耀等待玩家确认-来源参考[18]
...
![](images/4e9dffe7-591c-491f-9290-da3444bd6d09.jpg)
小约翰可汗选妃模拟代码
...
我们把这个例子类比一下，车辆就是线程，进入停车场就是线程在执行，离开停车场就是线程执行完毕，看见红灯就表示线程被阻塞，不能执行，Semaphore的本质就是
**协调多个线程对共享资源的获取** 。
...
![](images/683d1296-409b-4838-88dc-e3c904f91fee.jpg)
主要代码
...
![](images/26737926-86fa-45aa-abc3-c1021108fe24.jpg)
线程池参数
...
![](images/895c0b43-45e0-4326-b4c1-909018b08a2f.jpg)
...
![](images/65290f89-2fdf-4466-8528-088d4e105446.jpg)
FixedThreadPool
...
![](images/6f503fe3-d9ab-490c-a10e-80139c012031.jpg)
...
![](images/9126afd9-5c5d-4dad-8f9a-1c70d48dcb61.jpg)
...
![](images/0d5d25f7-9c2c-43db-9507-2e8a66fe5ba4.jpg)
...
![](images/49a0ecf0-27e2-4e94-be16-b6fc37c054d2.jpg)
线程池异常处理
...
![](images/2d0e1f5b-4088-4cd7-b4c8-f65220d904b1.jpg)
线程池状态切换图
...
![](images/c78bc3ee-5b50-4c92-8fbc-443e94578379.jpg)
JDK 线程池参数设置接口来源参考[7]

这里主要有两个思路：

![](images/f0451122-87f7-41fb-9c0a-e0ec620d5009.jpg)
动态修改线程池参数
...
![](images/9061751f-e09b-4b6e-bdc3-f9d77efb6445.jpg)
线程池调优
...
![](images/7368dd46-6a81-42a7-af1d-c8270e36714c.jpg)
线程池主要实现流程
...
![](images/9724498b-7cb4-4fbb-9804-9c0543257cdc.jpg)
自定义线程池
...
关于一些并发容器，可以去看看 [ 面渣逆袭：Java集合连环三十问
](https://mp.weixin.qq.com/s?__biz=MzkwODE5ODM0Ng==&mid=2247488788&idx=1&sn=01875e3e45515c2d57593cb7a01d0b6b&scene=21#wechat_redirect)
，里面有 ` CopyOnWriteList ` 和 ` ConcurrentHashMap ` 这两种线程安全容器类的问答。。
...
![](images/e6340bc6-4dea-445d-85a6-a475e478109d.jpg)
Fork/Join分治算法
...
那么问题来了，有的线程干活块，有的线程干活慢。干完活的线程不能让它空下来，得让它去帮没干完活的线程干活。它去其它线程的队列里窃取一个任务来执行，这就是所谓的
**工作窃取** 。

工作窃取发生的时候，它们会访问同一个队列，为了减少窃取任务线程和被窃取任务线程之间的竞争，通常任务会使用双端队列，被窃取任务线程永远从双端队列的头部拿，而窃取任务的线程永远从双端队列的尾部拿任务执行。

![](images/881d1c53-9b56-4615-b03a-860ded2a211a.jpg)
工作窃取
